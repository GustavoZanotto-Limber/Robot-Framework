...
${Caminho_Screenshots}=    ${EXECDIR}/EstruturasBase/DESKTOP/ScreenShots/SmokeTest/Bilheteria/ERP/Vendas/Consultas/    
${nome_print}
...
Lançamentos de Saídas
    ...
    RPA.Windows.Click         Carregar
    BaseKeywordsDesktop.Screenshot    Consulta de Lançamentos de Saídas (1)    ${Caminho_Screenshots}Lançamentos de Saídas
    Fechar janela
...
Lançamentos de Saídas - Item
    ...
    RPA.Windows.Click         Carregar
    BaseKeywordsDesktop.Screenshot    Lançamentos de Saída (1)    ${Caminho_Screenshots}Lançamentos de Saídas - Item
    Fechar janela
...
Movimentação de Clientes/Veículos
    ...
    RPA.Windows.Click         Carregar
    BaseKeywordsDesktop.Screenshot    Movimentação de Cliente/Veículo $ESPAÇO(1)    ${Caminho_Screenshots}Movimentação de Clientes/Veículos
    Fechar janela
...
Clientes/Veículos
    ...
    BaseKeywordsDesktop.Screenshot    Consulta de Clientes/Veículo (1)    ${Caminho_Screenshots}Clientes/Veículos
...
Orçamentos
    ...
    RPA.Windows.Click         Carregar
    BaseKeywordsDesktop.Screenshot    Consulta de Orçamentos (1)    ${Caminho_Screenshots}Orçamentos/Orçamentos
    Fechar janela
...
Pacotes Promocionais
    ...
    RPA.Windows.Click         Carregar
    BaseKeywordsDesktop.Screenshot    Consulta de Pacotes Promocionais (1)    ${Caminho_Screenshots}Pacotes Promocionais
    RPA.Windows.Click         Fechar
...
Pedidos de Vendas
    ...
    RPA.Windows.Click         Carregar
    BaseKeywordsDesktop.Screenshot    Consulta de Pedidos de Venda (1)    ${Caminho_Screenshots}Pedidos de Vendas
    Fechar janela
...
Tabela Preços de Venda
    ...
    RPA.Windows.Click         Carregar
    BaseKeywordsDesktop.Screenshot    Consulta de Preço de Venda de Produtos (1)    ${Caminho_Screenshots}Tabela Preços de Venda
    Fechar janela
