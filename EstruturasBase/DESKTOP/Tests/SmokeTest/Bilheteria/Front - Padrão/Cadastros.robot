...
${Caminho_Screenshots}=    ${EXECDIR}/EstruturasBase/DESKTOP/ScreenShots/SmokeTest/Bilheteria/Front - Padrao/Cadastros/    
${nome_print}
...
Guias
    [Tags]   SmokeERP   Cadastros    Front    SmokeTest   SmokeTestERP      
