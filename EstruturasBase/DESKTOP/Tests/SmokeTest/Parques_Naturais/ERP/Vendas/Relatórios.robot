...
Pedido de Venda > Rentabilidade de Pedidos de Venda
    ...
    BaseDesktop.Screenshot    Relatório de Rentabilidade de Pedidos de Venda (1)    ${Caminho_Screenshots}Pedido de Venda/Rentabilidade de Pedidos de Venda
    Fechar janela
...
Cadastros > Aniversariantes
    ...
    BaseDesktop.Screenshot    Relação de Aniversariantes (1)    ${Caminho_Screenshots}Cadastros/Aniversariantes
    Fechar janela
