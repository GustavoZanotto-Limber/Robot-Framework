...
${Caminho_Screenshots}=    ${EXECDIR}/EstruturasBase/Robot/ScreenShots/SmokeTest/Bilheteria/ERP/Vendedor/Cadastros/    
${nome_print}
...
Permissões de Acesso
    ...
    Base_Desktop.Screenshot    Permissões de Acesso para Vendedores (1)    ${Caminho_Screenshots}Permissões de Acesso
