...
${Caminho_Screenshots}=    ${EXECDIR}/EstruturasBase/Robot/ScreenShots/SmokeTest/Bilheteria/ERP/Frotas/Conhecimento de Transporte/    
${nome_print}
...
Conhecimento de Transporte > Emissão
    ...
    Base_Desktop.Screenshot  Conhecimento de Transporte (1)                             ${Caminho_Screenshots}Conhecimento de Transporte/Emissão
    Fechar com Sim
...
Conhecimento de Transporte > Cancelamento
    ...
    Base_Desktop.Screenshot  Conhecimento de Transporte Eletrônico - Cancelamento (1)                             ${Caminho_Screenshots}Conhecimento de Transporte/Cancelamento
...
Conhecimento de Transporte > Carta de Correção
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter
    Base_Desktop.Screenshot  Carta de Correção Eletrônica (1)                             ${Caminho_Screenshots}Conhecimento de Transporte/Carta de Correção
    RPA.Windows.Click       Confirmar
    Fechar Janela
...
Conhecimento de Transporte > Cálculo Desconto Quebra
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter
    Base_Desktop.Screenshot  Cálculo Desconto Quebra (1)                             ${Caminho_Screenshots}Conhecimento de Transporte/Cálculo Desconto Quebra
    RPA.Windows.Click       Confirmar
    Fechar Janela
...
Envio de Lote
    ...
    Base_Desktop.Screenshot  Emissão em Lote - Conhecimento de Transporte Eletrônico (1)                             ${Caminho_Screenshots}Envio em Lote
    Fechar Janela
...
Monitor de CT-e
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter
    Base_Desktop.Screenshot  Monitor - CT-e (1)                             ${Caminho_Screenshots}Monitor de CT-e
    RPA.Windows.Click       Confirmar
    Fechar Janela
...
Insucesso/Cancelar Insucesso
    ...
    Base_Desktop.Screenshot  CT-e Insucesso/Cancelamento de Insucesso (1)                             ${Caminho_Screenshots}Insucesso_Cancelar Insucesso
    RPA.Windows.Click       Confirmar
    RPA.Windows.Click       OK
    Fechar Janela
...
Averbação Online
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter
    Base_Desktop.Screenshot  Averbação Online (1)                             ${Caminho_Screenshots}Averbação Online
    RPA.Windows.Click       Confirmar
    Fechar Janela
...
Notas Fiscais Pendentes de Emissão de CT-e
    ...
    Base_Desktop.Screenshot  Notas Fiscais Pendentes de Emissão de CTe. (1)                             ${Caminho_Screenshots}Notas Fiscais Pendentes de Emissão de CT-e
    Fechar Janela
...
Subcontratação de CT-e
    ...
    RPA.Windows.Click       Atualizar
    Base_Desktop.Screenshot 	Subcontratação de CT-e (1)                             ${Caminho_Screenshots}Subcontratação de CT-e
    Fechar Janela
...
Recibo de Pagamento a Autônomo (RPA) > Emissão
    ...
    RPA.Windows.Click       Carregar
    Base_Desktop.Screenshot  Emissão de RPA (1)                             ${Caminho_Screenshots}Recibo de Pagamento a Autônomo (RPA)/Emissão
    Fechar Janela
...
Recibo de Pagamento a Autônomo (RPA) > Exclusão/Reimpressão
    ...
    RPA.Windows.Click       Carregar
    Base_Desktop.Screenshot 	Reimpressão/Exclusão de RPAs (1)                             ${Caminho_Screenshots}Recibo de Pagamento a Autônomo (RPA)/Exclusão_Reimpressão
    Fechar Janela
...
Recibo de Pagamento a Autônomo (RPA) > Consulta/Conferência de Conhecimento de Transporte
    ...
    RPA.Desktop.Press Keys      0
    RPA.Desktop.Press Keys      Enter
    Base_Desktop.Screenshot  	Consulta/Conferência de CTEs (1)                             ${Caminho_Screenshots}Recibo de Pagamento a Autônomo (RPA)/Consulta_Conferência de Conhecimento de Transporte
    RPA.Windows.Click           Confirmar
    Fechar Janela
