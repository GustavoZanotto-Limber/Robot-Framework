...
*** Variables ***
${Caminho_Screenshots}=    ${EXECDIR}/EstruturasBase/Robot/ScreenShots/SmokeTest/Bilheteria/ERP/Financeiro/Relatórios_Consultas/
${nome_print}
...
Informe de Rendimentos
    ...
    Base_Desktop.Screenshot    Informativo de Rendimentos (1)    ${Caminho_Screenshots}Informe de Rendimentos
    Fechar janela
...
Relatório de Receitas e Despesas
    ...
    Base_Desktop.Screenshot    Relatório de Receitas e Despesas (1)    ${Caminho_Screenshots}Relatório de Receitas e Despesas
...
Saldo de Pedidos de Venda
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter 
    Base_Desktop.Screenshot    Relatório de Saldos de Pedidos de Venda (1)    ${Caminho_Screenshots}Saldo de Pedidos de Venda
    RPA.Windows.Click         Confirmar
...
Posição Financeira > Configuração
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter 
    Base_Desktop.Screenshot    Configuração para Relatório de Posição Financeira (1)    ${Caminho_Screenshots}Posição Financeira/Configuração
    RPA.Windows.Click         Confirmar
    RPA.Windows.Click         OK
    Fechar janela
    RPA.Windows.Click         OK
...
Posição Financeira > Relatório
    ...
    Base_Desktop.Screenshot    Relatório de Posição Financeira (1)    ${Caminho_Screenshots}Posição Financeira/Relatório
    Fechar janela
...
Relatório Crédito Interno
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter 
    Base_Desktop.Screenshot    Relatório de Crédito Interno (1)    ${Caminho_Screenshots}Relatório Crédito Interno
    RPA.Windows.Click         OK
    Fechar janela
    RPA.Windows.Click         OK
...
Rateio de Centro de Custo
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter 
    Base_Desktop.Screenshot    Consulta de Rateio de Centro de Custos (1)    ${Caminho_Screenshots}Rateio de Centro de Custo
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Consumo de Adiantamento
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Consulta de Consumo de Adiantamentos (1)    ${Caminho_Screenshots}Consumo de Adiantamento
    Fechar janela
...
Análise de Terceiro
    ...
    Base_Desktop.Screenshot    Consulta de Terceiros    ${Caminho_Screenshots}Análise de Terceiro
    RPA.Windows.Click         Confirmar
    RPA.Windows.Get Text      Análise de Terceiros (1)
    Base_Desktop.Screenshot    Análise de Terceiros (1)    ${Caminho_Screenshots}Análise de Terceiro
    RPA.Windows.Click         Carregar
    RPA.Windows.Click         Fechar