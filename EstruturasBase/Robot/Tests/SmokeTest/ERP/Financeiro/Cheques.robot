...
${Caminho_Screenshots}=    ${EXECDIR}/EstruturasBase/Robot/ScreenShots/SmokeTest/Bilheteria/ERP/Financeiro/Cheques/    
${nome_print}
...
Cheques Emitidos
    ...
    Base_Desktop.Screenshot    Manutenção de Cheques (1)    ${Caminho_Screenshots}Cheques Emitidos
...
Cheques de Terceiros
    ...
    Base_Desktop.Screenshot    Movimentação de Cheques de Terceiros (1)    ${Caminho_Screenshots}Cheques de Terceiros
    Fechar com Sim
...
Relatório de Cheque de Terceiros
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter 
    Base_Desktop.Screenshot    Relatório de Cheque de Terceiros (1)    ${Caminho_Screenshots}Relatório de Cheque de Terceiros
    RPA.Windows.Click       Confirmar
    Fechar janela
...
Relatório de Cheques Emitidos
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter 
    Base_Desktop.Screenshot    Relatório de Cheques (1)    ${Caminho_Screenshots}Relatório de Cheques Emitidos
    RPA.Windows.Click       Confirmar
    Fechar janela
...
Relatórios de Cheques Cancelados/Excluídos
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter 
    Base_Desktop.Screenshot    Relatório de cheques cancelados (1)    ${Caminho_Screenshots}Relatórios de Cheques Cancelados_Excluídos
    RPA.Windows.Click       Confirmar
    Fechar janela
...
Layouts de Cheques para Emissão
    ...
    RPA.Windows.Click       Novo
    Base_Desktop.Screenshot    Configuração de Cheques (1)    ${Caminho_Screenshots}Layouts de Cheques para Emissão
    Fechar com Sim
...
Imprimir Multiplos Cheques
    ...
    Base_Desktop.Screenshot    Imprimir Cheques (1)    ${Caminho_Screenshots}Imprimir Multiplos Cheques
    Fechar janela