...
${Caminho_Screenshots}=    ${EXECDIR}/EstruturasBase/Robot/ScreenShots/SmokeTest/Bilheteria/ERP/Financeiro/Contas/    
${nome_print}
...
Movimentação de Contas
    ...
    Base_Desktop.Screenshot    Movimento de Contas (1)    ${Caminho_Screenshots}Movimentação de Contas
    Fechar com Sim
...
Transferências entre Contas
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Transferências (1)    ${Caminho_Screenshots}Transferências entre Contas
...
Transferências entre Estabelecimentos
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Transferência Entre Estabelecimentos (1)    ${Caminho_Screenshots}Transferências entre Contas
    Fechar com Sim
...
Conciliação de Cheques de Terceiros
    ...
    RPA.Windows.Click         Conciliar
    Base_Desktop.Screenshot    Conciliação de Cheques de Terceiros (1)    ${Caminho_Screenshots}Conciliação de Cheques de Terceiros
    RPA.Windows.Click         OK
    Fechar janela
...
Conciliação de Contas
    ...
    RPA.Windows.Click         Conciliar
    Base_Desktop.Screenshot    Conciliação de Contas    ${Caminho_Screenshots}Conciliação de Contas
    RPA.Windows.Click         OK
    Fechar janela
...
Estorno de Conciliação Cheques Terceiros
    ...
    RPA.Windows.Click         Executar
    Base_Desktop.Screenshot    Estorno de Conciliação de Cheques de Terceiros (1)    ${Caminho_Screenshots}Estorno de Conciliação Cheques Terceiros
    RPA.Windows.Click         OK
    Fechar janela
...
Conciliação de Transações Eletrônicas > Conciliação de Transações Eletrônicas Simplificadas
    ...
    Base_Desktop.Screenshot    Conciliação de Transações de Cartões Simplificado (1)    ${Caminho_Screenshots}Conciliação de Transações Eletrônicas/Conciliação de Transações Eletrônicas Simplificadas
    RPA.Windows.Click         OK
    Fechar janela
...
Conciliação de Transações Eletrônicas > Conciliação Arquivo PIX CNAB 750
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Conciliação Arquivo PIX CNAB 750 (1)    ${Caminho_Screenshots}Conciliação de Transações Eletrônicas/Conciliação Arquivo PIX CNAB 750
    RPA.Windows.Click         OK
    Fechar janela
...
Conciliação de Transações Eletrônicas > Conciliação de Transações PIX > API
    ...
    Base_Desktop.Screenshot    Conciliação de Transações Pix (1)    ${Caminho_Screenshots}Conciliação de Transações Eletrônicas/Conciliação de Transações PIX/API
    RPA.Windows.Click         OK
    Fechar janela
...
Conciliação de Transações Eletrônicas > Configuração de Arquivo de Importação
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Configuração de Arquivo de Importação (1)    ${Caminho_Screenshots}Conciliação de Transações Eletrônicas/Configuração de Arquivo de Importação
    Fechar com Sim
...
Apropriação de Custos (Centro de Custos)
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Apropriação de Custos (1)    ${Caminho_Screenshots}Apropriação de Custos (Centro de Custos)
    RPA.Windows.Click         OK
    Fechar janela
...
Encontro de Contas > Encontro de Contas
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Encontro de Contas (1)    ${Caminho_Screenshots}Encontro de Contas/Encontro de Contas
    RPA.Windows.Click         OK
    Fechar janela
...
Encontro de Contas > Estorno de Encontro de Contas
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Estorno de Encontro de Contas (1)    ${Caminho_Screenshots}Encontro de Contas/Estorno de Encontro de Contas
    RPA.Windows.Click         OK
    Fechar janela
...
Geração de Receitas Mapa Resumo > Geração de Receitas Mapa Resumo
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Geração de receitas pela redução Z (1)    ${Caminho_Screenshots}Geração de Receitas Mapa Resumo/Geração de Receitas Mapa Resumo
    RPA.Windows.Click         OK
    Fechar janela
...
Geração de Receitas Mapa Resumo > Configuração para geração de receitas
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Configuração para geração de receitas (1)    ${Caminho_Screenshots}Geração de Receitas Mapa Resumo/Configuração para geração de receitas
    Fechar com Sim
...
Geração de Receitas Mapa Resumo > Deduções Adicionais de ISS > Tipos de Deduções
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Cadastro de Tipos de Deduções (1)    ${Caminho_Screenshots}Geração de Receitas Mapa Resumo/Deduções Adicionais de ISS/Tipos de Deduções
    Fechar com Sim
...
Geração de Receitas Mapa Resumo > Deduções Adicionais de ISS > Lançamento de Deduções
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Lançamento de Dedução de ISS (1)    ${Caminho_Screenshots}Geração de Receitas Mapa Resumo/Deduções Adicionais de ISS/Lançamento de Deduções
    Fechar com Sim
...
Geração de Receitas Mapa Resumo > Deduções Adicionais de ISS > Consulta de Lançamentos
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Consulta de Lançamentos de Deduções (1)    ${Caminho_Screenshots}Geração de Receitas Mapa Resumo/Deduções Adicionais de ISS/Consulta de Lançamentos
    Fechar janela
...
Geração de Receitas Mapa Resumo > Vinculo Cliente em Venda
    ...
    Base_Desktop.Screenshot    Vínculo de Cliente em Venda (1)    ${Caminho_Screenshots}Geração de Receitas Mapa Resumo/Vinculo Cliente em Venda
...
Geração de Receitas Mapa Resumo > Emissão de NFS-e/CT-e sobre Reduções
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Gerar NFS-e/CT-e sobre Serviços (1)    ${Caminho_Screenshots}Geração de Receitas Mapa Resumo/Emissão de NFS-e_CT-e sobre Reduções
    RPA.Windows.Click         OK
    Fechar janela
...
Geração de Receitas Mapa Resumo > Mapa Resumo da ECF
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Mapa Resumo da ECF (1)    ${Caminho_Screenshots}Geração de Receitas Mapa Resumo/Mapa Resumo da ECF
    Fechar com Sim
...
Geração de Receitas Mapa Resumo > Fechamento de Caixas
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Fechamento de Caixas (1)    ${Caminho_Screenshots}Geração de Receitas Mapa Resumo/Fechamento de Caixas
    Fechar janela
...
Geração de Receitas Mapa Resumo > Configuração de Centros de Custos por PDV
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter
    Base_Desktop.Screenshot    Configuração de Centro de Custos por PDV (1)    ${Caminho_Screenshots}Geração de Receitas Mapa Resumo/Configuração de Centros de Custos por PDV
...
Zeramento de Cartões Crédito Interno
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Zeramento de Saldo de Cartões Crédito Interno Pré Pago (1)    ${Caminho_Screenshots}Zeramento de Cartões Crédito Interno
    RPA.Windows.Click         OK
    Fechar janela
...
Consultas > Razão de Contas
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Razão de Contas (1)    ${Caminho_Screenshots}Consultas/Razão de Contas
    RPA.Windows.Click         OK
    Fechar janela
...
Consultas > Balancete
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Balancete (1)    ${Caminho_Screenshots}Consultas/Balancete
    RPA.Windows.Click         OK
    Fechar janela
...
Consultas > Diário
    ...
    RPA.Windows.Click         Executar
    Base_Desktop.Screenshot    Lançamentos Diários (1)    ${Caminho_Screenshots}Consultas/Diário
    RPA.Windows.Click         OK
    Fechar janela
...
Consultas > Pesquisa de Lançamentos
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Manutenção de Lançamentos contábeis (1)    ${Caminho_Screenshots}Consultas/Pesquisa de Lançamentos
    RPA.Windows.Click         OK
    Fechar janela
...
Consultas > Livro Caixa
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Consulta Livro Caixa (1)    ${Caminho_Screenshots}Consultas/Livro Caixa
    RPA.Windows.Click         OK
    Fechar janela
...
Relatórios > Razão Gerencial
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter 
    Base_Desktop.Screenshot    Razão Gerencial (1)    ${Caminho_Screenshots}Relatórios/Razão Gerencial
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Relatórios > Balancete
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter 
    Base_Desktop.Screenshot    Balancete (1)    ${Caminho_Screenshots}Relatórios/Balancete
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Relatórios > Livro caixa
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter 
    Base_Desktop.Screenshot    Extrato de Conta (1)    ${Caminho_Screenshots}Relatórios/Livro caixa
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Relatórios > Movimentação de Caixa
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter 
    Base_Desktop.Screenshot    Relatório de Movimentação de Caixa (1)    ${Caminho_Screenshots}Relatórios/Movimentação de Caixa
    RPA.Windows.Click         Confirmar
    Fechar janela
