...
${Caminho_Screenshots}=    ${EXECDIR}/EstruturasBase/Robot/ScreenShots/SmokeTest/Bilheteria/ERP/Vendas/Manutenções/    
${nome_print}
...
Saídas/Vendas > Incluir/Alterar - Sem Fechamento
    ...
    Base_Desktop.Screenshot    Saidas/Vendas - Produtos - Sem Fechamento (1)    ${Caminho_Screenshots}Saídas_Vendas/Incluir_Alterar - Sem Fechamento
    Fechar com Sim
...
Saídas/Vendas > Incluir - Com Fechamento
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Saidas/Vendas - Produtos - Com Fechamento (1)    ${Caminho_Screenshots}Saídas_Vendas/Incluir - Com Fechamento
    Fechar com Sim
...
Saídas/Vendas > Fechar Saídas/Vendas Abertas
    ...
    RPA.Windows.Get Text      Saidas/Vendas - Produtos - Com Fechamento (1)
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Saidas/Vendas - Produtos - Com Fechamento (1)    ${Caminho_Screenshots}Saídas_Vendas/Fechar Saídas_Vendas Abertas
    Fechar com Sim    
...
Saídas/Vendas > Alterar Saídas/Vendas
    ...
    Base_Desktop.Screenshot    Saidas/Vendas - Produtos - Alterar Saídas/Vendas (1)    ${Caminho_Screenshots}Saídas_Vendas/Alterar Saídas_Vendas
...
Saídas/Vendas > Consultar Saídas/Vendas
    ...
    Sleep                     1s
    RPA.Windows.Click         Confirmar
    Base_Desktop.Screenshot    Saidas/Vendas - Produtos - Consulta (1)    ${Caminho_Screenshots}Saídas_Vendas/Consultar Saídas_Vendas
    Fechar janela
...
Saídas/Vendas > Excluir Saídas/Vendas
    ...
    Sleep                     1s
    RPA.Windows.Click         Confirmar
    Base_Desktop.Screenshot    Excluir saídas/vendas (1)    ${Caminho_Screenshots}Saídas_Vendas/Excluir Saídas_Vendas
    Fechar janela
...
Saídas/Vendas > Venda Simplificada
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter
    Base_Desktop.Screenshot    Venda Simplificada (1)    ${Caminho_Screenshots}Saídas_Vendas/Venda Simplificada
    RPA.Windows.Click         Confirmar
...
Ordem de Serviço > Abrir Ordem de Serviço
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Saidas/Vendas - Abertura de Ordem de Serviço (1)      ${Caminho_Screenshots}Ordem de Serviço/Abrir Ordem de Serviço
    RPA.Windows.Click         OK
    Fechar com Sim
...
Ordem de Serviço > Movimentar Ordem de Serviço
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Saidas/Vendas - Movimento de Ordem de Serviço (1)    ${Caminho_Screenshots}Ordem de Serviço/Movimentar Ordem de Serviço
    RPA.Windows.Click         OK
    Fechar janela
...
Ordem de Serviço > Fechar Ordem de Serviço
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Saidas/Vendas - Fechamento de Ordem de Serviço (1)    ${Caminho_Screenshots}Ordem de Serviço/Fechar Ordem de Serviço
    RPA.Windows.Click         OK
    Fechar com Sim
...
Ordem de Serviço > Alterar Ordem de Serviço
    ...
    Sleep                     1s
    RPA.Windows.Click         Confirmar
    Base_Desktop.Screenshot    Saidas/Vendas - Alterar Ordem de Serviço (1)   ${Caminho_Screenshots}Ordem de Serviço/Alterar Ordem de Serviço
    Fechar janela
...
Ordem de Serviço > Consultar Ordem de Serviço
    ...
    Sleep                     1s
    RPA.Windows.Click         Confirmar
    Base_Desktop.Screenshot    Saidas/Vendas - Consulta de Ordem de Serviço (1)    ${Caminho_Screenshots}Ordem de Serviço/Consultar Ordem de Serviço
    Fechar janela
...
Ordem de Serviço > Excluir Ordem de Serviço
    ...
    Sleep                     1s
    RPA.Windows.Click         Confirmar
    Base_Desktop.Screenshot    Excluir saídas/vendas (1)    ${Caminho_Screenshots}Ordem de Serviço/Excluir Ordem de Serviço
    Fechar janela
...
Saídas para Venda Ambulante > Cadastro de Motivo de Retorno de Vendas Ambulantes
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Cadastro de Motivo de Retorno de Vendas Ambulantes (1)    ${Caminho_Screenshots}Saídas para Venda Ambulante/Cadastro de Motivo de Retorno de Vendas Ambulantes
    Fechar com Sim
...
Saídas para Venda Ambulante > Saídas para Venda Ambulante
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Lançamento de Saída para Venda Ambulante (1)    ${Caminho_Screenshots}Saídas para Venda Ambulante/Saídas para Venda Ambulante
    Fechar com Sim
...
Saídas para Venda Ambulante > Controle de Venda e Devoluções de Saídas para Venda Ambulante
    ...
    Base_Desktop.Screenshot    Controle de Venda e Devoluções de Saídas para Venda Ambulante (1)    ${Caminho_Screenshots}Saídas para Venda Ambulante/Controle de Venda e Devoluções de Saídas para Venda Ambulante
    Fechar janela
...
Saídas para Venda Ambulante > Excluir Venda Ambulante
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter
    Base_Desktop.Screenshot    Exclusão de Vendas Ambulantes (1)    ${Caminho_Screenshots}Saídas para Venda Ambulante/Excluir Venda Ambulante
    RPA.Windows.Click         OK
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Demais Operações de Saída > Manutenção de Devolução de Compra
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Manutenção de Devolução de Compras (1)    ${Caminho_Screenshots}Demais Operações de Saída/Manutenção de Devolução de Compra
    RPA.Windows.Click         OK
    Fechar janela
...
Demais Operações de Saída > Manutenção de Entrega Futura
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Manutenção de Venda de Entrega Futura (1)    ${Caminho_Screenshots}Demais Operações de Saída/Manutenção de Entrega Futura
    RPA.Windows.Click         OK
    Fechar janela
...
Demais Operações de Saída > Manutenção de Saídas Diversas
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Manutenção de Saídas Diversas (1)    ${Caminho_Screenshots}Demais Operações de Saída/Manutenção de Saídas Diversas
    Fechar janela
...
Demais Operações de Saída > Emissão de notas fiscais sobre Saídas
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Consulta de vendas para Geração de Nota (1)    ${Caminho_Screenshots}Demais Operações de Saída/Emissão de notas fiscais sobre Saídas
    RPA.Windows.Click         OK
    Fechar janela
...
Demais Operações de Saída > Estornar Fechamentos Vendas/Ordens de Serviços
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Cancelar Fechamentos (1)    ${Caminho_Screenshots}Demais Operações de Saída/Estornar Fechamentos Vendas_Ordens de Serviços
    Fechar janela
...
Demais Operações de Saída > Agendamentos > Tipo Contato
    ...
    Base_Desktop.Screenshot    Cadastro de tipo de Histórico de Contatos (1)    ${Caminho_Screenshots}Demais Operações de Saída/Agendamentos/Tipo Contato
    Fechar janela
...
Demais Operações de Saída > Agendamentos > Contato
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Registro de Contato (1)    ${Caminho_Screenshots}Demais Operações de Saída/Agendamentos/Contato
    Fechar com Sim
...
Demais Operações de Saída > Agendamentos > Agendamento
    ...
    Base_Desktop.Screenshot    Agendar (1)    ${Caminho_Screenshots}Demais Operações de Saída/Agendamentos/Agendamento
    RPA.Windows.Click         OK
    Fechar janela
...
Demais Operações de Saída > Agendamentos > Consultar Agendamentos
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Consulta de agendamentos (1)    ${Caminho_Screenshots}Demais Operações de Saída/Agendamentos/Consultar Agendamentos
    Fechar janela
...
Demais Operações de Saída > Agendamentos > Relatório de Contatos
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter
    Base_Desktop.Screenshot    Relatório de Registro de Contatos (1)    ${Caminho_Screenshots}Demais Operações de Saída/Agendamentos/Relatório de Contatos
    RPA.Windows.Click         OK
    Fechar janela
    RPA.Windows.Click         OK
...
Demais Operações de Saída > Agendamentos > Relatório de Agendamentos
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter
    Base_Desktop.Screenshot    Relatório de Agendamentos (1)    ${Caminho_Screenshots}Demais Operações de Saída/Agendamentos/Relatório de Agendamentos
    RPA.Windows.Click         OK
    Fechar janela
    RPA.Windows.Click         OK
...
Demais Operações de Saída > Condicional > Inclusão de Saídas em Condicional
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Saída em Condicional (1)    ${Caminho_Screenshots}Demais Operações de Saída/Condicional/Inclusão de Saídas em Condicional
    Fechar com Sim
...
Demais Operações de Saída > Condicional > Manutenção/consulta de saídas em condicional
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Manutenção de Saídas em Condicional (1)    ${Caminho_Screenshots}Demais Operações de Saída/Condicional/Manutenção_consulta de saídas em condicional
    Fechar janela
...
Demais Operações de Saída > Condicional > Saldo de saídas em condicional
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Saldo de Saídas em Condicional (1)    ${Caminho_Screenshots}Demais Operações de Saída/Condicional/Saldo de saídas em condicional
    Fechar janela
...
Demais Operações de Saída > Fixação de vendas
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Fixação de Vendas (1)    ${Caminho_Screenshots}Demais Operações de Saída/Fixação de vendas
    RPA.Windows.Click         OK
    Fechar janela
...
Demais Operações de Saída > Exportação > Venda para exportação
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter
    Base_Desktop.Screenshot    Vendas para Exportação (1)    ${Caminho_Screenshots}Demais Operações de Saída/Exportação/Venda para exportação
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Demais Operações de Saída > Exportação > Venda para Exportação - Pendentes
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter
    Base_Desktop.Screenshot    Vendas para Exportação - Pendentes (1)    ${Caminho_Screenshots}Demais Operações de Saída/Exportação/Venda para Exportação - Pendentes
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Demais Operações de Saída > Exportação > Relatório de Movimentação
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter
    Base_Desktop.Screenshot    Vendas para Exportação - Relatório (1)    ${Caminho_Screenshots}Demais Operações de Saída/Exportação/Relatório de Movimentação
    RPA.Windows.Click         Confirmar
    Fechar janela
Documentos Fiscais > NF-e > Emissão de Notas Fiscais Eletrônicas
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Emissão de Notas Fiscais Eletrônicas (1)    ${Caminho_Screenshots}Documentos Fiscais/NF-e/Emissão de Notas Fiscais Eletrônicas
    Fechar janela
...
Documentos Fiscais > NF-e > Monitorar NFe's
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Monitor de NF-e/NFC-e (1)    ${Caminho_Screenshots}Documentos Fiscais/NF-e/Monitorar NFe's
    Fechar janela
...
Documentos Fiscais > NF-e > Inutilização de Numeração
    ...
    Base_Desktop.Screenshot    Nota Fiscal Eletrônica - Inutilização de Numeração (1)    ${Caminho_Screenshots}Documentos Fiscais/NF-e/Inutilização de Numeração
...
Documentos Fiscais > NF-e > Inutilização de Numeração(Envio Rápido)
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Inutilização de Numeração - Envio Rápido (1)    ${Caminho_Screenshots}Documentos Fiscais/NF-e/Inutilização de Numeração(Envio Rápido)
    Fechar janela
...
Documentos Fiscais > NF-e > Carta de Correção Eletrônica
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Carta de Correção Eletrônica (1)    ${Caminho_Screenshots}Documentos Fiscais/NF-e/Carta de Correção Eletrônica
    RPA.Windows.Click         OK
    RPA.Windows.Click         Fechar
...
Documentos Fiscais > NF-e > Insucesso de Entrega da NF-e
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Nota Fiscal Eletrônica - Insucesso na Entrega (1)    ${Caminho_Screenshots}Documentos Fiscais/NF-e/Insucesso de Entrega da NF-e
    RPA.Windows.Click         OK
    Fechar janela
...
Documentos Fiscais > Monitorar NFSE's
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Consulta de Notas Fiscais de Serviço Eletrônicas (1)      ${Caminho_Screenshots}Documentos Fiscais/Monitorar NFSE's
    Fechar janela
...
Documentos Fiscais > Monitorar GNRE
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Consulta de Vendas e GNRE (1)  ${Caminho_Screenshots}Documentos Fiscais/Monitorar GNRE
    Fechar janela
...
Documentos Fiscais > ECF > Leitura X
    ...
    Base_Desktop.Screenshot    Leitura X (1)    ${Caminho_Screenshots}Documentos Fiscais/ECF/Leitura X
    Fechar janela
...
Documentos Fiscais > ECF > Redução Z
    ...
    Base_Desktop.Screenshot    Redução Z (1)    ${Caminho_Screenshots}Documentos Fiscais/ECF/Redução Z
    Fechar janela
...
Documentos Fiscais > ECF > Relatório Gerencial
    ...
    Base_Desktop.Screenshot    Relatório Gerencial (1)    ${Caminho_Screenshots}Documentos Fiscais/ECF/Relatório Gerencial
    Fechar janela
...
Documentos Fiscais > ECF > Cancelar Último Cupom
    ...
    Base_Desktop.Screenshot    Cancelar Último Cupom (1)    ${Caminho_Screenshots}Documentos Fiscais/ECF/Cancelar Último Cupom
    Fechar janela
...
Documentos Fiscais > ECF > Mapa Resumo (Redução Z)
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Mapa Resumo da ECF (1)    ${Caminho_Screenshots}Documentos Fiscais/ECF/Mapa Resumo (Redução Z)
    Fechar com Sim
...
Documentos Fiscais > MDF-e > Manifesto de Documentos Fiscais
    ...
    Base_Desktop.Screenshot    Manifesto de Documentos Fiscais (1)    ${Caminho_Screenshots}Documentos Fiscais/MDF-e/Manifesto de Documentos Fiscais
    Fechar janela
...
Documentos Fiscais > MDF-e > Monitor - MDF-e
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Monitor MDF-e (1)    ${Caminho_Screenshots}Documentos Fiscais/MDF-e/Monitor - MDF-e
    Fechar janela
...
Documentos Fiscais > MDF-e > Importar NF-e para MDF-e
    ...
    Base_Desktop.Screenshot    Importador MDF-e (1)    ${Caminho_Screenshots}Documentos Fiscais/MDF-e/Importar NF-e para MDF-e
    Fechar janela
...
Pedidos > Pedidos de Venda > Pedido de Venda
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Pedidos de Venda (1)    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Pedido de Venda
    Fechar com Sim
...
Pedidos > Pedidos de Venda > Zeramento de Pedido
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Zeramento de Pedido de Venda (1)    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Zeramento de Pedido
    Fechar com Sim
...
Pedidos > Pedidos de Venda > Pré Zeramento de Pedido
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Pré Zeramento de Pedido de Venda (1)    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Pré Zeramento de Pedido
    Fechar com Sim
...
Pedidos > Pedidos de Venda > Gerar Venda por Pedido de Venda
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Gerador de Vendas por Pedido de Venda (1)    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Gerar Venda por Pedido de Venda
    Fechar janela
...
Pedidos > Pedidos de Venda > Pedido de Venda Simplificado
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Pedido de Venda Simplificado    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Pedido de Venda Simplificado
    Fechar com Sim
...
Pedidos > Pedidos de Venda > Manutenção de Pedido de Venda
    ...
    Base_Desktop.Screenshot    Manutenção de Pedido de Venda (1)    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Manutenção de Pedido de Venda
    RPA.Windows.Click         OK
    Fechar janela
...
Pedidos > Pedidos de Venda > Cadastro de Status
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Cadastro de Status - Pedido de Venda (1)    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Cadastro de Status
    Fechar com Sim
...
Pedidos > Pedidos de Venda > Aprovação/Rejeição
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Aprovação/Rejeição de Pedidos de Venda (1)    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Aprovação_Rejeição
    Fechar janela
...
Pedidos > Pedidos de Venda > Estorno da Aprovação
    ...
    Base_Desktop.Screenshot    Estorno da Aprovação de Pedidos de Venda (1)    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Estorno da Aprovação
    RPA.Windows.Click         Fechar
...
Pedidos > Pedidos de Venda > Enviar Email para Aprovação/Rejeição Pedido de Venda
    ...
    RPA.Windows.Click         Carregar    
    Base_Desktop.Screenshot    Envio de Email para Pedidos de Venda Aprovados/Rejeitados (1)    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Enviar Email para Aprovação_Rejeição Pedido de Venda
    Fechar janela
...
Pedidos > Pedidos de Venda > Definir lotes - Expedição
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Definir lotes Expedição (1)    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Definir lotes - Expedição
    Fechar janela
...
Pedidos > Pedidos de Venda > Modelo de Impressão
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter
    Base_Desktop.Screenshot    Configuração de Layout Personalizado (1)    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Modelo de Impressão
    RPA.Windows.Click         Confirmar
    Fechar com Sim    
...
Pedidos > Pedidos de Venda > Agrupamento de Pedidos de Venda > Agrupar Pedidos de Venda
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Agrupador de Pedidos de Venda    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Agrupamento de Pedidos de Venda/Agrupar Pedidos de Venda
    RPA.Windows.Click         Fechar  
...
Pedidos > Pedidos de Venda > Agrupamento de Pedidos de Venda > Estornar Pedidos de Venda Agrupados
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Estorno de Agrupamento de Pedidos de Venda (1)    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Agrupamento de Pedidos de Venda/Estornar Pedidos de Venda Agrupados
    Fechar janela
...
Pedidos > Pedidos de Venda > Agrupamento de Pedidos de Venda > Relatório de Pedidos de Venda Agrupados
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter
    Base_Desktop.Screenshot    Relatório de Pedidos de Venda Agrupados (1)    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Agrupamento de Pedidos de Venda/Relatório de Pedidos de Venda Agrupados
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Pedidos > Pedidos de Venda > Reprocessamento de Custos Gerenciais de Pedido de Venda
    ...
    Base_Desktop.Screenshot    Reprocessamento Custos Gerenciais Pedido de Venda (1)    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Reprocessamento de Custos Gerenciais de Pedido de Venda
    RPA.Windows.Click         OK  
    Fechar janela
...
Pedidos > Pedidos de Transferência
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Pedido de Transferência (1)    ${Caminho_Screenshots}Pedidos/Pedidos de Venda/Pedidos de Transferência
    Fechar com Sim
...
Orçamentos > Orçamentos
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Orçamentos (1)    ${Caminho_Screenshots}Orçamentos/Orçamentos
    RPA.Windows.Click         OK
    Fechar com Sim
...
Orçamentos > Consulta
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Consulta de Orçamentos (1)    ${Caminho_Screenshots}Orçamentos/Consulta
    Fechar janela
...
Pesagem Geral
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Consulta de Pesagem Geral (1)    ${Caminho_Screenshots}Pesagem Geral
    Fechar janela
...
Controle de Viagens de Vendedores > Lançamento de Viagens
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Lançamento de Viagens (1)    ${Caminho_Screenshots}Controle de Viagens de Vendedores/Lançamento de Viagens
    Fechar com Sim
...
Controle de Viagens de Vendedores > Lançamento de Despesas
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Lançamento de Despesas (1)    ${Caminho_Screenshots}Controle de Viagens de Vendedores/Lançamento de Despesas
    Fechar com Sim
...
Controle de Viagens de Vendedores > Relatório de Despesas
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter
    Base_Desktop.Screenshot    Relatório de Despesas (1)    ${Caminho_Screenshots}Controle de Viagens de Vendedores/Relatório de Despesas
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Gerenciamento de Preços > Formação de Preços de Venda
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Formação de Preços de Venda (1)    ${Caminho_Screenshots}Gerenciamento de Preços/Formação de Preços de Venda
    RPA.Windows.Click         OK
    Fechar janela
...
Gerenciamento de Preços > Tabela de Preços Condicionais
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Tabela de Preço Condicional (1)    ${Caminho_Screenshots}Gerenciamento de Preços/Tabela de Preços Condicionais
    Fechar janela
...
Gerenciamento de Preços > Tabela de Preços de Venda
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Tabela de Preços de Venda (1)    ${Caminho_Screenshots}Gerenciamento de Preços/Tabela de Preços de Venda
    RPA.Windows.Click         Sim
    Fechar janela
...
Caixa Operador > Abertura
    ...
    RPA.Desktop.Press Keys    Enter
    RPA.Windows.Click         Confirmar
    Base_Desktop.Screenshot    Abertura de Caixa    ${Caminho_Screenshots}Caixa Operador/Abertura
    Fechar janela
...
Caixa Operador > Suprimento/Entradas
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Suprimento/Entradas    ${Caminho_Screenshots}Caixa Operador/Suprimento_Entradas
    Fechar com Sim
...
Caixa Operador > Sangria/Saídas
    ...
    RPA.Windows.Click         Novo
    Base_Desktop.Screenshot    Sangria\\Saidas    ${Caminho_Screenshots}Caixa Operador/Sangria_Saídas
    Fechar com Sim
...
Caixa Operador > Fechamento
    ...
    RPA.Desktop.Press Keys    Enter
    RPA.Windows.Click         Confirmar
    Base_Desktop.Screenshot    Fechamento de Caixa    ${Caminho_Screenshots}Caixa Operador/Fechamento
    Fechar janela
...
Caixa Operador > Relatório
    ...
    RPA.Desktop.Press Keys    0
    RPA.Desktop.Press Keys    Enter
    Base_Desktop.Screenshot    Relatório do Caixa Operador (1)    ${Caminho_Screenshots}Caixa Operador/Relatório
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Processos Personalizados
    ...
    Base_Desktop.Screenshot    Processos Personalizados (1)    ${Caminho_Screenshots}Caixa Operador/Processos Personalizados
...
Controle de Recorrências
    ...
    RPA.Windows.Click         Carregar
    Base_Desktop.Screenshot    Consulta de Recorrências (1)    ${Caminho_Screenshots}Caixa Operador/Controle de Recorrências
    RPA.Windows.Click         OK
    Fechar janela
