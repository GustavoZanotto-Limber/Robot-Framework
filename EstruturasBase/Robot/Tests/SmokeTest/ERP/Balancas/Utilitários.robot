...
${Caminho_Screenshots}=    ${EXECDIR}/EstruturasBase/Robot/ScreenShots/SmokeTest/Bilheteria/ERP/Balanças/Utilitários/    
${nome_print}
...
Configuração da Balança
    ...
    Base_Desktop.Screenshot  Configuração da Balança (1)    ${Caminho_Screenshots}Verificar Transações Abertas
    Fechar janela
