...
${Caminho_Screenshots}=    ${EXECDIR}/EstruturasBase/Robot/ScreenShots/SmokeTest/Bilheteria/ERP/Contabil/Relatórios/    
${nome_print}
...
Livro Diário
    ...
    Base_Desktop.Screenshot    Livro Diário (1)     ${Caminho_Screenshots}Livro Diário
...
Razão
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter
    Base_Desktop.Screenshot    Razão Contabil (1)     ${Caminho_Screenshots}Razão
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Balancete
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter
    Base_Desktop.Screenshot    Balancete (1)     ${Caminho_Screenshots}Balancete
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Balancete por Plano de Contas Referencial
    ...
    Base_Desktop.Screenshot    Balancete por Plano de Contas Referencial (1)     ${Caminho_Screenshots}Balancete por Plano de Contas Referencial
    Fechar janela
...
Balanço Patrimonial/Demonstrativo DRE
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter
    Base_Desktop.Screenshot    Balanço/Demonstrativo Integrado (1)     ${Caminho_Screenshots}Balanço Patrimonial_Demonstrativo DRE
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Demonstrativo de Fluxo de Caixa - DFC
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter
    Base_Desktop.Screenshot    Demonstrativo de Fluxo de Caixa - DFC (1)       ${Caminho_Screenshots}Demonstrativo de Fluxo de Caixa - DFC
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Balanço Patrimonial Comparado
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter
    Base_Desktop.Screenshot    Balanço Patrimonial Comparado (1)     ${Caminho_Screenshots}Balanço Patrimonial Comparado
    RPA.Windows.Click         Confirmar
    Fechar janela
...
DMPL/DMPS
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter
    Base_Desktop.Screenshot    DMPL/DMPS (1)     ${Caminho_Screenshots}DMPL_DMPS
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Extrato de Conta
    ...
    Base_Desktop.Screenshot    Extrato de Conta (1)     ${Caminho_Screenshots}Extrato de Conta
    Fechar janela
...
Lançamentos
    ...
    Base_Desktop.Screenshot    Relação de Lançamentos (1)     ${Caminho_Screenshots}Lançamentos
    Fechar janela
...
Termos
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter 
    Base_Desktop.Screenshot    Emissão dos Termos de Abertura/Encerramento (1)     ${Caminho_Screenshots}Termos
...
Cadastros > Plano de Contas
    ...
    Base_Desktop.Screenshot    Relatório de Plano de Contas (1)     ${Caminho_Screenshots}Cadastros/Plano de Contas
    Fechar janela
...
Cadastros > Históricos
    ...
    Base_Desktop.Screenshot    Relatório de Históricos Contábeis (1)      ${Caminho_Screenshots}Cadastros/Históricos
    Fechar janela
...
Cadastros > Centros de Custos
    ...
    RPA.Windows.Click         Ordem de Nome
    Base_Desktop.Screenshot    Relatório de Centros de Custos (1)    ${Caminho_Screenshots}Cadastros/Centros de Custos
    Fechar janela
...
Cadastros > Localidades
    ...
    RPA.Windows.Click         Ordem de Nome
    Base_Desktop.Screenshot    Relatório de Localidades (1)    ${Caminho_Screenshots}Cadastros/Localidades
    Fechar janela
...
Informativo de Rendimentos
    ...
    Base_Desktop.Screenshot    Informativo de Rendimentos (1)     ${Caminho_Screenshots}Informativo de Rendimentos
    Fechar janela
...
Customizados > Relatório de Imobilização
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter
    Base_Desktop.Screenshot    Relatório de Imobilizado (1)      ${Caminho_Screenshots}Customizados/Relatório de Imobilização
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Receitas / Despesas
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter 
    Base_Desktop.Screenshot    Relatório de Receitas e Despesas (1)     ${Caminho_Screenshots}Receitas _ Despesas
    RPA.Windows.Click         Confirmar
    Fechar janela
...
Despesas Antecipadas
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter 
    Base_Desktop.Screenshot    Relatório de Despesas Antecipadas (1)     ${Caminho_Screenshots}Despesas Antecipadas
    RPA.Windows.Click         OK
...
Centro de Custos (Borderô)
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter 
    Base_Desktop.Screenshot    Relatório de Centro de Custos (Borderô) (1)     ${Caminho_Screenshots}Centro de Custos (Borderô)
    RPA.Windows.Click         OK
    RPA.Windows.Click         Fechar
    RPA.Windows.Click         OK      
...
Faturamento
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter 
    Base_Desktop.Screenshot    Relatório de Faturamento (1)     ${Caminho_Screenshots}Faturamento
    RPA.Windows.Click         Confirmar
    Fechar janela