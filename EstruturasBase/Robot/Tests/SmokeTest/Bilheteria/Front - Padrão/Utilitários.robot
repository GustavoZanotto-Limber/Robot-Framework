...
${Caminho_Screenshots}=    ${EXECDIR}/EstruturasBase/Robot/ScreenShots/SmokeTest/Bilheteria/Front - Padrao/Utilitários/ 
${nome_print}
...
Favoritos
    [Tags]   SmokeERP   Utilitários    Front    SmokeTest    
    ...
    Base_Desktop.Screenshot  Configuração dos Favoritos (1)    ${Caminho_Screenshots}Favoritos
...
Layout de Bilhetes
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter
    Base_Desktop.Screenshot  Layout de Bilhetes (1)    ${Caminho_Screenshots}Layout de Bilhetes
    RPA.Windows.Click       Confirmar
    Fechar com Sim
...
Configuração de Impressoras
    ...
    Base_Desktop.Screenshot  Configuração Impressoras (1)    ${Caminho_Screenshots}Configuração de Impressoras
    Fechar janela
...
Observações Padrão
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter
    Base_Desktop.Screenshot  Cadastro de Observações Padrão (1)    ${Caminho_Screenshots}Observações Padrão
    RPA.Windows.Click       Confirmar
    Fechar janela
...
Verificar Transações Abertas
    ...
    RPA.Windows.Click       Carregar
    Base_Desktop.Screenshot  Verifica transações abertas (1)    ${Caminho_Screenshots}Verifica Transações Abertas
    Fechar janela
...
Abrir Gaveta
    ...
    Base_Desktop.Screenshot  Salvar Saída de Impressão como    ${Caminho_Screenshots}Abrir Gaveta
    RPA.Windows.Click       Fechar
...
Metas Orçamento/Previsão
    ...
    RPA.Desktop.Press Keys  0
    RPA.Desktop.Press Keys  Enter
    Base_Desktop.Screenshot  Cadastro de Metas para BI (1)    ${Caminho_Screenshots}Metas Orçamento_Previsão
    RPA.Windows.Click       Confirmar
    Fechar com Sim
...
Metas Realizadas Adicionais
    ...
    RPA.Windows.Click       Carregar
    Base_Desktop.Screenshot  Lançamentos de Metas Realizadas (1)    ${Caminho_Screenshots}Metas Realizadas Adicionais
    Fechar janela