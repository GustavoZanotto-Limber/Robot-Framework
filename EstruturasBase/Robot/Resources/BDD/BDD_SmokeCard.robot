...
Então valido se a tela de Extrato Eletrônico de Transações foi carregada corretamente
    Conferir texto                   xpath:/html/body/app-root/app-pages/div/div/div/app-split/div/h1    Gerenciamento Split de Pagamento
    ...
    Conferir texto                   xpath:/html/body/div[3]/div/div/mat-snack-bar-container/div/div/div/div/simple-snack-bar/div[1]            Selecione um Modo de Pagamento
    
Então valido se a tela de Gerenciamento de Compradores foi carregada corretamente
    Conferir texto   xpath:/html/body/app-root/app-pages/div/div/div/app-compradores/h1    Gerenciamento de Compradores
...
Então valido se a tela de bilhetes abriu corretamente
    Conferir texto       xpath:/html/body/app-root/app-pages/div/div/div/lista-bilhetes/lista-cadastros-com-busca/div/div/h1  Gerenciamento de Bilhetes
    ...
    Conferir texto       xpath:/html/body/app-root/app-pages/div/div/div/new-or-edit-bilhete/div[1]/div/h1    Novo Bilhete
...
Então valido o a pagina de metas 
    Conferir texto                xpath:/html/body/app-root/app-pages/div/div/div/app-metas/div/div/h1    Configurações de Meta
...
Então valido o titulo e clico em novo 2   
    [Arguments]    ${titulo_pagina}    ${tiulo_pagina_novo}    ${rota_html}    ${rota_html_novo}
    Validar o titulo e clicar em novo     ${titulo_pagina}     ${rota_html}
    Conferir texto                xpath:/html/body/app-root/app-pages/div/div/div/${rota_html_novo}/div[1]/h1    ${tiulo_pagina_novo}
                                                

Então valido o titulo das TAG clico em novo 
    Validar o titulo e clicar em novo      Gerenciamento de Tag's     app-tag
    Conferir texto                 xpath:/html/body/app-root/app-pages/div/div/div/app-new-or-edit-tag/div[1]/div/h1    Nova TAG

                                                  
Então valido se a tela de Configuração de preços e Disponibilidades foi carregada corretamente
    Conferir texto     xpath:/html/body/app-root/app-pages/div/div/div/app-config-preco/div/h1    Configuração de preço
    ...
    Conferir texto     xpath:/html/body/app-root/app-pages/div/div/div/app-config-preco/mat-card/div[2]/nav/div[2]/div/div/a[1]/span[2]/span/span    Tabela de Preço
    Clicar no Elemento              xpath:/html/body/app-root/app-pages/div/div/div/app-config-preco/mat-card/div[2]/nav/div[2]/div/div/a[2]
    Conferir texto     xpath:/html/body/app-root/app-pages/div/div/div/app-config-preco/mat-card/div[2]/nav/div[2]/div/div/a[2]/span[2]/span/span    Tabela de Disponibilidade
    Clicar no Elemento              xpath:/html/body/app-root/app-pages/div/div/div/app-config-preco/mat-card/div[2]/nav/div[2]/div/div/a[3]
    Conferir texto     xpath:/html/body/app-root/app-pages/div/div/div/app-config-preco/mat-card/div[2]/nav/div[2]/div/div/a[3]/span[2]/span/span    Calendário
...
Então valido se a tela de Gerenciamento de Lotes foi carregada corretamente
    ...
    Conferir texto               xpath:/html/body/app-root/app-pages/div/div/div/app-new-or-edit-grupo-lote/div/div/h1    Grupo de Lotes
    ...
    Sleep                                1s    
    Conferir texto               xpath:/html/body/app-root/app-pages/div/div/div/app-new-or-edit-grupo-lote/div/mat-card/mat-tab-group/div/mat-tab-body[2]/div/tabela-config-lotes/div/div[1]/h3    Selecione a data de visita
    Clicar no Elemento                   xpath:/html/body/app-root/app-pages/div/div/div/app-new-or-edit-grupo-lote/div/mat-card/mat-tab-group/mat-tab-header/div[2]/div/div/div[2]
    Sleep                                1s
    Conferir texto               xpath:/html/body/app-root/app-pages/div/div/div/app-new-or-edit-grupo-lote/div/mat-card/mat-tab-group/div/mat-tab-body[2]/div/tabela-config-lotes/div/div[1]/h3    Selecione a data de visita
...
Então valido se a tela de Ocupação de Disponibilidade Online foi carregada corretamente
    Conferir texto     xpath:/html/body/app-root/app-pages/div/div/div/app-disp-online/div/h1    Calendário de disponibilidade online
...
Então Valido a tela de SAC
    Conferir texto    xpath:/html/body/app-root/app-pages/div/div/div/app-sac/div/h1    Registro de Chamados
    ...
    Conferir texto    xpath:/html/body/app-root/app-pages/div/div/div/app-view-sac/div[1]/div/h1    Chamado: 2025-10-457723
    Conferir texto    xpath:/html/body/app-root/app-pages/div/div/div/app-view-sac/div[1]/mat-card/div[2]/mat-form-field/div[1]/div/div[2]/textarea    Testes Automatizados
    
Então valido as Requisições de Acordo
    Conferir texto    xpath:/html/body/app-root/app-pages/div/div/div/app-requisicoes-acordo/h2    Agências/Parceiros que requisitaram um acordo
...
Então Valido a tela de bilheteria
    Sleep                     2s
    Conferir texto    xpath:/html/body/app-root/app-pages/div/div/div/app-lista-bilheterias/lista-cadastros-com-busca/div/div/h1    Configurações de bilheteria
    Sleep                     2s
    ...
    Sleep                     2s
    Conferir texto    xpath:/html/body/app-root/app-pages/div/div/div/app-popups-totem/lista-cadastros-com-busca/div/div/h1    Popups - Totem
    ...
    Sleep                     2s
    Conferir texto    xpath:/html/body/app-root/app-pages/div/div/div/new-or-edit-popup-totem/div[1]/div/h2    Novo pop-up
...
Então valido a tela de Perfil de Venda
    ...
    Sleep                                1s
    Conferir texto               xpath:/html/body/app-root/app-pages/div/div/div/app-new-or-edit-perfil/div[1]/div/h2    Novo Perfil
...
Então valido se a tela de Notificações foi carregada corretamente     
    Conferir texto    xpath:/html/body/app-root/app-pages/div/div/div/notificacoes/h1    Notificações
    Clicar no Elemento        xpath:/html/body/app-root/app-pages/div/div/div/notificacoes/h1
    Sleep                     2s
    Conferir texto    xpath:/html/body/app-root/app-pages/div/div/div/notificacoes/div/mat-card[5]/logs/div[2]/table/tbody/tr[1]/td[1]    Automação

Então valido se a tela de Logs Nuvem foi carregada corretamente
    Conferir texto    xpath:/html/body/app-root/app-pages/div/div/div/ng-component/mat-card[1]/mat-card-title    Gerenciamento de Logs - Nuvem
...
Então valido o cadastro de Clientes de E-Commerce's
    Sleep                     2s    
    Conferir texto    xpath:/html/body/app-root/app-pages/div/div/div/clientes-ecommerce/lista-cadastros/div/div[1]/h1    Clientes de E-commerce`s
    ...
    Sleep                     1s
    Conferir texto    xpath:/html/body/div[3]/div[3]/div/mat-dialog-container/div/div/info-cliente/form/div[1]/div/h2[1]    609 - Gustavo Zanotto Limber
...
Então valido o cadastro de Tick Ingressos
    ...
    Sleep                                  1s
    Conferir texto                 xpath:/html/body/div[3]/div[3]/div/mat-dialog-container/div/div/add-estabelecimento-usuario/div/div[1]/h2    Novo Terminal
...
Então valido o cadastro de Agrupador de Agências
    Conferir texto     xpath:/html/body/app-root/app-pages/div/div/div/app-agrupador-agencias/div/div/h1    Agrupador de Agências/Parceiros
...
Então valido se a tela de Central de Vendas foi carregada corretamente
    Conferir texto    xpath:/html/body/app-root/app-central-vendas/div/central-vendas-toolbar/mat-toolbar     Central de Vendas
    Conferir texto    xpath:/html/body/app-root/app-central-vendas/div/div/div/central-vendas-estabelecimentos/lista-cadastros-com-busca/div/div/h1    Estabelecimentos
    ...
    Conferir texto    xpath:/html/body/app-root/app-central-vendas/div/div/div/app-venda/div/mat-card/h1    Dados Iniciais
    Preencher dados central de vendas
    Conferir texto    xpath:/html/body/app-root/app-central-vendas/div/div/div/app-venda/div/div/mat-card/h1    Experiências   
    Clicar no Elemento        xpath:/html/body/app-root/app-central-vendas/div/central-vendas-toolbar/div/ul/li[2]
    Sleep                     1s    
    Conferir texto    xpath:/html/body/app-root/app-central-vendas/div/div/div/app-gerenciador-vendas/div/div[1]/h1    Gerenciamento de Vendas

Então valido o Load Balancing
    Conferir texto    xpath:/html/body/app-root/app-pages/div/div/div/app-load-balancing/h1     Load Balacing - E-commerce's  
...
Então valido se a tela de Verificar Transações foi carregada corretamente
    Conferir texto    xpath:/html/body/app-root/app-pages/div/div/div/app-transacoes/mat-expansion-panel/mat-expansion-panel-header/span[1]/mat-panel-title/h1    Verificador de Transações
    ...
    Conferir texto    xpath:/html/body/div[3]/div/div/mat-snack-bar-container/div/div/div/div/simple-snack-bar/div[1]     Pesquisa das Transações realizada.
